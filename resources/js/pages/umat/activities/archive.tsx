...
import { Calendar, Clock, MapPin, Eye, ArrowLeft, ChevronRight } from 'lucide-react';
...
export default function ActivitiesArchive({ activities }: Props) {
                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center">
                                <div className="bg-gray-500/10 p-3 rounded-full mr-4">
                        ...
                        <div className="bg-white/70 backdrop-blur-sm rounded-lg p-6 border border-gray-200">
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <div className="text-center">
                                    ...
                                    <p className="text-church-text/70 text-sm">Total Arsip</p>
                                </div>
                                <div className="text-center">
                    ...
                    {activities.data.length > 0 ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                            {activities.data.map((activity) => {
                                ...
                                return (
                                    <Card key={activity.id} className="group hover:shadow-lg transition-all duration-300 border-gray-200 bg-white/80 backdrop-blur-sm overflow-hidden opacity-90">
                                        {/* Date Header - Archived Style */}
                                        <div className="bg-gradient-to-r from-gray-500 to-gray-600 p-4 text-white">
                                            <div className="flex justify-between items-center mb-2">
                                                <div className="px-2 py-1 rounded-full text-xs font-medium bg-gray-700 text-white">
                                                    Selesai
                                                </div>
                                        ...
                                        <CardHeader className="pb-2">
                                            <CardTitle className="text-lg text-gray-700 group-hover:text-church-primary transition-colors duration-300 line-clamp-2">
                                                {activity.name}
                                            </CardTitle>
                                        </CardHeader>
                                        ...
                                        <CardContent className="pt-0">
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <Link
                                                    ...
                                                    className="inline-flex items-center px-3 py-1 text-xs bg-gray-600 text-white rounded-full hover:bg-gray-500 transition-colors duration-300"
                                                >
                        ...
                        <div className="text-center py-16">
                            <div className="bg-gray-500/10 w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6">
                            ...
                            {activities.links.map((link, index) => {
                                if (!link.url) {
                                    return (
                                        <span
                                            key={index}
                                            className="px-3 py-2 text-gray-400 bg-white/50 rounded-md border border-gray-200"
